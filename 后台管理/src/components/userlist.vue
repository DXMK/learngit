<template>
  <div class="userlist">
    <h2>用户管理中心</h2>
    <el-button type="primary" size="mini" @click="exit" id='exit'>退出</el-button>
    <!-- 导航栏 -->
    <el-col :span="4">
      <el-menu id="nav">
        <el-menu-item index="1" @click="userShow(1)">
          <i class="el-icon-user"></i>
          <span>用户列表</span>
        </el-menu-item>
        <el-menu-item index="2" @click="queryShow">
          <i class="el-icon-search"></i>
          <span>用户查询</span>
        </el-menu-item>
        <el-menu-item index="3" @click="addShow">          
    ...
    <el-col :span="20">
        ...
        <el-form ref="from" label-width="80px" size="mini" :model="queryusers">
          ...
          <el-col :span="14" :offset="1">
            <el-form-item label="详细地址:">
              <el-input placeholder="**区**门**路**小区" v-model="queryusers.city"></el-input>
            </el-form-item>
          </el-col>
      ...
      <el-col :span="24" v-show="usershow!=''" id="mytable">
        ...
        <el-table :data="users" header-align="left">
          ...
          <el-table-column align="center" prop="name" label="name" width="100"></el-table-column>
          <el-table-column align="center" prop="province" label="province" width="130"></el-table-column>
          <el-table-column align="center" prop="city" label="city" width="130"></el-table-column>
          <el-table-column align="center" prop="address" label="address" width="130"></el-table-column>
          <el-table-column align="center" prop="zip" label="zip" width="130"></el-table-column>
          <el-table-column align="center" prop="date" label="birthday" width="120"></el-table-column>
        ...
        <el-button size="mini" :disabled="nowpage==1">
          <i class="el-icon-d-arrow" @click="userShow(1)">首页</i>
        </el-button>

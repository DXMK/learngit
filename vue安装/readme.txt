...
后端提供的接口:
查询所有学生信息接口
http://192.168.1.254:80/deal/data
响应结果数据:
[
	{"age":18,"name":"李四","sex":"男","stuid":2},
	{"age":30,"name":"王五","sex":"女","stuid":3},
	{"age":10,"name":"admin1","sex":"男","stuid":4},
	{"age":10,"name":"admin2","sex":"男","stuid":5}
]

删除指定学生信息接口
http://192.168.1.254:80/deal/delete?stuid=1
响应结果:
success - 删除成功
fail - 删除失败
...
(2)在项目的配置文件 config -> index.js, 中添加跨域的配置
 dev: {
    ...
    proxyTable: {
      '/deal': {
        target: 'http://192.168.1.220:80', // 后端服务器的域名: 主机Ip+端口号
